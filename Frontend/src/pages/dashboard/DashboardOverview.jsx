    ...
    <div className="flex flex-col gap-6 sm:gap-8 max-w-7xl mx-auto px-1 sm:px-2">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-indigo-500 to-blue-600 text-white p-6 sm:p-8 md:p-10 shadow-xl shadow-indigo-100">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
          ...
          <div className="shrink-0 flex items-center gap-4 bg-white/15 backdrop-blur-md p-4 sm:p-5 rounded-2xl border border-white/25 shadow-sm">
            <div className="w-14 h-14 rounded-xl bg-white text-indigo-600 flex items-center justify-center font-black text-2xl shadow-md">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        >
          ...
          <div className="mt-3 flex items-center gap-1.5 text-xs text-indigo-700 font-bold">
            <TrendingUp className="w-4 h-4 text-emerald-600" /> Top: {summary?.topEmergingSkill || 'AI Platform & Cloud'}
          </div>
          <p className="text-xs text-slate-500 mt-2.5 leading-relaxed">
      ...
      <section className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm">
        <div className="flex items-center justify-between pb-4 mb-6 border-b border-slate-100">
          ...
          <div className="hidden sm:flex items-center gap-2 px-3 py-1 bg-emerald-50 text-emerald-700 text-xs font-bold rounded-full border border-emerald-200">
          ...
          {quickLaunchPillars.map((p) => {
            ...
            return (
              <div
                ...
                className="group cursor-pointer p-5 rounded-2xl bg-white border border-slate-200 hover:border-indigo-400 hover:shadow-lg hover:shadow-indigo-50/50 hover:-translate-y-0.5 transition-all flex items-center justify-between"
              >
                <div className="flex items-center gap-3.5">
                  <div className="w-11 h-11 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-all shadow-sm">
